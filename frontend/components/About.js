            ...
            <div className=' px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
                <div className='max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12'>
                    ...
                    <p className='text-base text-white md:text-lg'>
                        SafeBet is a dApp where you can play different games and
                        its fully powered by the Ethereum blockchain. Play a
                        Lottery and get a chance to win a prize. Bet on
                        Cryptocurrency, if it goes up or down and win money.
                    </p>
                </div>
                <div className='grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-4 sm:grid-cols-2'>
                    ...
                    <div className='duration-300 transform bg-white border-l-4 border-secondary-color hover:-translate-y-2 h-40'>
                        <div className='h-full p-5 border border-l-0 rounded-r shadow-sm'>
                            ...
                            <p className='text-sm text-gray-900'>
                                Play our games and you have the chance to win
                                money.
                            </p>
                        </div>
                    </div>
                    <div className='duration-300 transform bg-white border-l-4 border-secondary-color hover:-translate-y-2 h-40'>
                        <div className='h-full p-5 border border-l-0 rounded-r shadow-sm'>
                            ...
                            <p className='text-sm text-gray-900'>
                                Join the Lottery where you have the chance to
                                win money.
                            </p>
                        </div>
                    </div>
                    <div className='duration-300 transform bg-white border-l-4 border-secondary-color hover:-translate-y-2 h-40'>
                        <div className='h-full p-5 border border-l-0 rounded-r shadow-sm'>
                            ...
                            <p className='text-sm text-gray-900'>
                                The prices of Cryptocurrencies are changing all
                                the time. Bet on them and win money.
                            </p>
                        </div>
                    </div>
                </div>
