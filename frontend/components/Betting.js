...
export default function Betting() {
	...
	const {active, activate, deactivate, account, connector, library, chainId} = useWeb3React()
	...
	const renderButton = () => {
		...
		if (active) {
			return (
				<button className='font-bold text-white border-secondary-color border-2  py-3 px-24 focus:outline-none rounded text-lg transition-all duration-500 ease-in-out ' onClick={disconnectWallet}>
					Wallet Connected!
				</button>
			);
		}
	...
	return (
		<div className='min-h-screen flex flex-col justify-between w-full'>
			<Navbar option1="Crypto Bet" link1="/Dashboard/Bet" option2="Rotary Game" link2="/Dashboard/Rotary" option3="Dashboard" link3='/Dashboard' page="Crypto Bet" />
