...
import { Lotter_CONTRACT_ADDRESS, Lotter_abi, Lottery_abi, Lottery_CONTRACT_ADDRESS } from "../../constants";
...
const Lotter = () => {
    ...
    const enterRaffle = async (amount) => {
        try {
            ...
            const tx = await contract.enterRaffle({ value: utils.parseEther(amount) });
										...
										<div className='shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-900 w-full'>
											...
											<div className='mt-4 flex flex-col justify-center items-center w-full'>
												<h2 className='text-white text-3xl font-light'>
													<i>Entry Fee: {entryFee} ETH</i>
												</h2>
												<button onClick={() => enterRaffle("0.1")} className='my-8 font-bold text-white bg-secondary-color shadow-md shadow-glow border-0 py-2 px-16 focus:outline-none rounded text-lg transition-all duration-500 ease-in-out hover:scale-90'>
													Pay
												</button>
											</div>
										</div>
										...
										<div className='shadow-lg rounded-2xl bg-white dark:bg-gray-900 w-full'>
											...
											<p className='font-bold text-6xl px-4 pb-4 text-black dark:text-white'>
												<span className='text-transparent bg-clip-text bg-gradient-to-b from-pink-700 to-sf-violet'>
													{ raffleState === 0 ? "Lottery Open!" : "Lottery Paused." }
												</span>
											</p>
										</div>
									</div>
									...
									<div className='mb-4'>
										<div className='shadow-lg rounded-2xl bg-white dark:bg-gray-900 w-full'>
											...
											<p className='p-4 text-2xl text-transparent bg-clip-text bg-gradient-to-b from-pink-700 to-sf-violet font-bold font-bebas tracking-wide'>
												{recentWinner === "" ? "Let's start the lottery with you!" : `${recentWinner}`}
											</p>
										</div>
									</div>
								</div>
